* req-package
  ...
  [[http://melpa.org/#/req-package][http://melpa.org/packages/req-package-badge.svg]]
  [[http://stable.melpa.org/#/req-package][http://stable.melpa.org/packages/req-package-badge.svg]]
  [[https://travis-ci.org/edvorg/req-package][https://travis-ci.org/edvorg/req-package.svg]]
  [[https://coveralls.io/github/edvorg/req-package?branch=develop][https://coveralls.io/repos/edvorg/req-package/badge.svg?branch=develop&service=github]]
